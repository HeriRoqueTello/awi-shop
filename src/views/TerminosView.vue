<template>
  <div class="about">
    <h1>Términos y Condiciones de Uso de la Plataforma de Tiendas Virtuales</h1>

    <small>Última actualización: 16/08/23</small>

    <p>
      Los siguientes términos y condiciones ("Términos") rigen el uso de la
      plataforma de tiendas virtuales ("Plataforma") por parte de los usuarios y
      vendedores. Al acceder o utilizar la Plataforma, usted acepta cumplir con
    ...
    <p>
      1.2. Usted es responsable de garantizar la confidencialidad de sus
      credenciales de inicio de sesión y de cualquier actividad que ocurra bajo
      su cuenta.
    </p>
    ...
    <p>
      ...
      Plataforma y su contenido son propiedad exclusiva de Ñawi Shop o de los
      vendedores en caso de contenido de vendedores.
    </p>
    <p>
      3.2. Queda prohibida la reproducción, distribución o modificación de
      cualquier contenido de la Plataforma sin el consentimiento previo por
      escrito.
    </p>

    <h3>4. Productos y Transacciones</h3>
    <p>
    ...
    <p>
      4.2. Las transacciones de compra se realizan directamente entre el usuario
      y el vendedor. Ñawi Shop no es responsable de la calidad, entrega o
    ...
    <p>
      ...
      Política de Privacidad, que será enviado a su correo electrónico una vez
      cree su cuenta.
    </p>
    ...
    <p>
      ...
      productos. Ñawi Shop no otorga garantías sobre los productos vendidos en
      la Plataforma.
    </p>

    <h3>9. Cancelación y Suspensión</h3>
    ...
    <h3>10. Modificaciones de Términos</h3>

    <p>
      10.1. Ñawi Shop se reserva el derecho de modificar estos Términos en
      cualquier momento. Las modificaciones serán efectivas a partir de su
    ...
    <p>
      ...
      Cualquier disputa se resolverá en los tribunales competentes de Lima
      Metropolitana.
    </p>
    <strong>
      Si tiene preguntas o inquietudes sobre estos Términos, por favor
      contáctenos en servicioalcliente@ñawishop.pe
    </strong>
  </div>
</template>
